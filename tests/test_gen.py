...
from tests.mock import cat_dog_shop, enum_example, literal_example, marriage, show_optional, type_alias
...
def test_gen2(module: ModuleType, root: str, relations: Relations, expected_path: str) -> None:
    mg = MermaidGenerator(module)
    chart = mg.generate_chart(root=root, relations=relations)
    compare_chart_and_markdown(chart, expected_path)
